...
<?php
  ...
  ?>
<script>
    function change_nacionalnost() {
      pol=document.getElementById('sex');
      nacionalnost=document.getElementById('nacionalnost');
      if(pol.value=='m'){
      document.getElementById('m').innerHTML='Македонец';
      document.getElementById('a').innerHTML='Албанец';
      document.getElementById('t').innerHTML='Турчин';
      document.getElementById('s').innerHTML='Србин';
      document.getElementById('r').innerHTML='Ром';
      document.getElementById('v').innerHTML='Влав';
      document.getElementById('b').innerHTML='Боснијак';
      }else if(pol.value=='z'){
      document.getElementById('m').innerHTML='Македонка';
      document.getElementById('a').innerHTML='Албанка';
      document.getElementById('t').innerHTML='Турчинка';
      document.getElementById('s').innerHTML='Србинка';
      document.getElementById('r').innerHTML='Ромка';
      document.getElementById('v').innerHTML='Влавка';
      document.getElementById('b').innerHTML='Боснијака';
    }
  }
</script>
</head>
...
<div id="div_1">
    <div id="position_1">
      <img src="includes/pozicija-1.png">
    </div><br><br>
    <div class="field">
    ...
    <button type="button" name="button"id="next_1" onclick="document.getElementById('div_1').style.visibility='hidden'; document.getElementById('div_2').style.visibility='visible';">Next</button>
</div>

<div id="div_2">
    <div id="position_1">
      <img src="includes/pozicija-2.png">
    </div><br><br><br>
    <div class="field">
    ...
    <button type="button" name="button"id="next_2" onclick="document.getElementById('div_2').style.visibility='hidden'; document.getElementById('div_3').style.visibility='visible';">Next</button>
    <button type="button" name="button"id="back_1" onclick="document.getElementById('div_2').style.visibility='hidden'; document.getElementById('div_1').style.visibility='visible';">Back</button>

</div>

<div id="div_3">
    <div id="position_3">
      <img src="includes/pozicija-3.png">
    </div><br><br><br>
    ...
    <select id="sex" name="sex" onchange="change_nacionalnost();" >
    ...
    <select id="nacionalnost" name="nacionalnost">
       ...
       <option id="m" value="M">Македонец/ка</option>
       <option id="a" value="A">Албанец/ка</option>
       <option id="t" value="T">Турчин/ка</option>
       <option id="s" value="S">Србин/ка</option>
       <option id="r" value="R">Ром/ка</option>
       <option id="v" value="V">Влав/ка</option>
       <option id="b" value="B">Боснијак</option>
       <option value="D">Друго</option>
    </select><br><br>
   <div class="g-recaptcha" data-sitekey="6LeVuSoUAAAAAEvr7p2emCHC_CkHmllSnMuR2fuN"></div>
   <input type="hidden" name="token" value="<?php echo Token::generate(); ?>"/>
    <br>
    <button type="button" name="button"id="back_2" onclick="document.getElementById('div_3').style.visibility='hidden'; document.getElementById('div_2').style.visibility='visible';">Back</button>
    <input id="register" type="submit" value="Регистрација"/>
 </div>
</form>
