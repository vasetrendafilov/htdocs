...
<head>
    ...
    <title>chat-engine-gravatar - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">chat-engine-gravatar</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Update all Users's state and add a gravatar property based on <code>user.state().email</code>. Result assigned to <code>user.state().gravatar</code>.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-gravatar_src_plugin.js.html">chat-engine-gravatar/src/plugin.js</a>, <a href="chat-engine-gravatar_src_plugin.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="module:chat-engine-gravatar">

    <span class="type-signature"></span>require('chat-engine-gravatar')<span class="signature">(config<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-gravatar_src_plugin.js.html">chat-engine-gravatar/src/plugin.js</a>, <a href="chat-engine-gravatar_src_plugin.js.html#line20">line 20</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>chat = new ChatEngine.Chat(new Date().getTime());
user = new OCF.User('ian', {email: 'ian@pubnub.com'});
user.plugin(gravatar());
console.log(user.state().gravatar());</code></pre>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The plugin config object</p>
                <h6>Properties</h6>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The <a href="User.html#state">User#state</a> property to use as gravatar.</p></td>
        </tr>
...
<h4 class="name" id="~state()%22.%22gravatar">

<span class="type-signature">(inner) </span>state().gravatar<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-gravatar_src_plugin.js.html">chat-engine-gravatar/src/plugin.js</a>, <a href="chat-engine-gravatar_src_plugin.js.html#line29">line 29</a>
    </li></ul></dd>
