...
<head>
    ...
    <title>Me - PubNub ChatEngine</title>
...
<article>
    ...
    <span class="type-signature"></span>new Me<span class="signature">(uuid)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line1201">line 1201</a>
    </li></ul></dd>
...
<div class="description">
    <p>Represents the client connection as a special <a href="User.html">User</a> with write permissions.
    Has the ability to update it's state on the network. An instance of
    <a href="Me.html">Me</a> is returned by the <code>ChatEngine.connect()</code>
    method.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The uuid of this user</p></td>
        </tr>
...
<span class="type-signature">(readonly) </span>chats<span class="type-signature"> :Object</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line1094">line 1094</a>
    </li></ul></dd>
    ...
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#chats">User#chats</a>
    </li></ul></dd>
...
<div class="description">
    <p>An object containing the Chats this <a href="User.html">User</a> is currently in. The key of each item in the object is the Chat.channel and the value is the <a href="Chat.html">Chat</a> object. Note that for privacy, this map will only contain <a href="Chat.html">Chat</a>s that the client (<a href="Me.html">Me</a>) is also connected to.</p>
</div>
...
<h4 class="name" id="direct">

<span class="type-signature"></span>direct<span class="type-signature"> :<a href="Chat.html">Chat</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line1135">line 1135</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#direct">User#direct</a>
    </li></ul></dd>
...
<div class="description">
    <p>Direct is a private channel that anybody can publish to but only
...
<a href="Chat.html#invite">Chat#invite</a> method for private chats utilizing
<a href="User.html#direct">User#direct</a>.</p>
</div>
...
// another instance
them.direct.connect();
them.direct.emit('private-message', {secret: 42});</code></pre>
...
<h4 class="name" id="feed">

<span class="type-signature"></span>feed<span class="type-signature"> :<a href="Chat.html">Chat</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line1113">line 1113</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#feed">User#feed</a>
    </li></ul></dd>
...
<div class="description">
    <p>Feed is a Chat that only streams things a User does, like
...
not be able to converse in this channel.</p>
</div>
...
// another instance
them.feed.connect();
them.feed.on('update', (payload) => {})</code></pre>
...
<span class="type-signature">(readonly) </span>uuid<span class="type-signature"> :String</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line1068">line 1068</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#uuid">User#uuid</a>
    </li></ul></dd>
...
<div class="description">
    <p>The User's unique identifier, usually a device uuid. This helps ChatEngine identify the user between events. This is public id exposed to the network.
            Check out <a href="https://en.wikipedia.org/wiki/Universally_unique_identifier">the wikipedia page on UUIDs</a>.</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <span class="type-signature"></span>state<span class="signature">(chat)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line1162">line 1162</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#state">User#state</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets the user state in a <a href="Chat.html">Chat</a>. See <a href="Me.html#update">Me#update</a> for how to assign state values.</p>
</div>
...
<span class="param-type"><a href="Chat.html">Chat</a></span>
            ...
            <td class="description last"><p>Chatroom to retrieve state from</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns a generic JSON object containing state information.</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <span class="type-signature"></span>update<span class="signature">(state, chat)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line1247">line 1247</a>
    </li></ul></dd>
...
<div class="description">
    <p>Update <a href="Me.html">Me</a>'s state in a <a href="Chat.html">Chat</a>. All <a href="User.html">User</a>s in
the <a href="Chat.html">Chat</a> will be notified of this change via ($.update)[Chat.html#event:$%2522.%2522state].
Retrieve state at any time with <a href="User.html#state">User#state</a>.</p>
</div>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The new state for <a href="Me.html">Me</a></p></td>
        </tr>
...
<span class="param-type"><a href="Chat.html">Chat</a></span>
            ...
            <td class="description last"><p>An instance of the <a href="Chat.html">Chat</a> where state will be updated.
Defaults to <code>ChatEngine.global</code>.</p></td>
        </tr>
...
<ul>
    ...
    <h4 class="name" id="event:$%22.%22invite">
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line514">line 514</a>
    </li></ul></dd>
    ...
    <dd class="tag-tutorial">
        <ul>
            <li><a href="tutorial-private.html">Private Chats</a></li>
        </ul>
    </dd>
...
<div class="description">
    <p>Notifies <a href="Me.html">Me</a> that they've been invited to a new private <a href="Chat.html">Chat</a>.
Fired by the <a href="Chat.html#invite">Chat#invite</a> method.</p>
</div>
    ...
    <pre class="prettyprint"><code>me.direct.on('$.invite', (payload) => {
