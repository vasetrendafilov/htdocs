...
<head>
    ...
    <title>Angular Bootstrap - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">Angular Bootstrap</h1>
...
<article>
    <iframe src="https://chat-engine-examples.surge.sh/angular/simple/index.html" width="100%" height="400px"></iframe>
