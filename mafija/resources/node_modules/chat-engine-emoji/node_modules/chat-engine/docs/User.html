...
<head>
    ...
    <title>User - PubNub ChatEngine</title>
...
<header>
        ...
        User
            ...
            <div class="class-description"><p>This is our User class which represents a connected client. User's are automatically created and managed by <a href="Chat.html">Chat</a>s, but you can also instantiate them yourself.
    If a User has been created but has never been authenticated, you will recieve 403s when connecting to their feed or direct Chats.</p></div>
...
<article>
    ...
    <span class="type-signature"></span>new User<span class="signature">(uuid, state, chat)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line1055">line 1055</a>
    </li></ul></dd>
