...
<head>
    ...
    <title>chat-engine-unread-messages - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">chat-engine-unread-messages</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Emits the <code>$unread</code> event on a <a href="Chat.html">Chat</a> when a <code>message</code> event is received and the Chat is not marked as active.</p></div>
    ...
    <h4 class="name" id="module:chat-engine-unread-messages">

    <span class="type-signature"></span>require('chat-engine-unread-messages')<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-unread-messages_src_plugin.js.html">chat-engine-unread-messages/src/plugin.js</a>, <a href="chat-engine-unread-messages_src_plugin.js.html#line26">line 26</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>chat.plugin(ChatEngineCore.plugin['chat-engine-unread-messages']());
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-unread-messages_src_plugin.js.html">chat-engine-unread-messages/src/plugin.js</a>, <a href="chat-engine-unread-messages_src_plugin.js.html#line1">line 1</a>
    </li></ul></dd>
...
<h4 class="name" id="~unreadCount">

<span class="type-signature">(inner) </span>unreadCount<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Augments:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-unread-messages_src_plugin.js.html">chat-engine-unread-messages/src/plugin.js</a>, <a href="chat-engine-unread-messages_src_plugin.js.html#line80">line 80</a>
    </li></ul></dd>
...
<h4 class="name" id="~unreadMessages%22.%22isActive">

<span class="type-signature">(inner) </span>unreadMessages.isActive<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-unread-messages_src_plugin.js.html">chat-engine-unread-messages/src/plugin.js</a>, <a href="chat-engine-unread-messages_src_plugin.js.html#line32">line 32</a>
    </li></ul></dd>
...
<div class="description">
    <p>Adds the property Chat.isActive to the applied Chat.</p>
</div>
...
<h4 class="name" id="~unreadMessages%22.%22unreadCount">

<span class="type-signature">(inner) </span>unreadMessages.unreadCount<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-unread-messages_src_plugin.js.html">chat-engine-unread-messages/src/plugin.js</a>, <a href="chat-engine-unread-messages_src_plugin.js.html#line39">line 39</a>
    </li></ul></dd>
...
<div class="description">
    <p>Adds the property Chat.unreadCount to the applied Chat.</p>
</div>
    ...
    <h4 class="name" id="~unreadMessages%22.%22active">

    <span class="type-signature">(inner) </span>unreadMessages.active<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-unread-messages_src_plugin.js.html">chat-engine-unread-messages/src/plugin.js</a>, <a href="chat-engine-unread-messages_src_plugin.js.html#line88">line 88</a>
    </li></ul></dd>
...
<div class="description">
    <p>INdicate that the chat is in the background and unread messages should increment.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-unread-messages_src_plugin.js.html">chat-engine-unread-messages/src/plugin.js</a>, <a href="chat-engine-unread-messages_src_plugin.js.html#line72">line 72</a>
    </li></ul></dd>
...
<div class="description">
    <p>Indicate that this <a href="Chat.html">Chat</a> is visible to the user.
The property unreadCount is set to 0 and will not increment until inactive() is called.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-unread-messages_src_plugin.js.html">chat-engine-unread-messages/src/plugin.js</a>, <a href="chat-engine-unread-messages_src_plugin.js.html#line52">line 52</a>
    </li></ul></dd>
...
<span class="param-type"><a href="Chat.html">Chat</a></span>
            ...
            <td class="description last"><p>This chat</p></td>
        </tr>
...
<span class="param-type"><a href="User.html">User</a></span>
            ...
            <td class="description last"><p>The sender of the unread message</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The raw <code>message</code> event.</p></td>
        </tr>
