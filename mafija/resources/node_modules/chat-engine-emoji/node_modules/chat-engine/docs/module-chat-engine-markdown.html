...
<head>
    ...
    <title>chat-engine-markdown - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">chat-engine-markdown</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Renders markdown from the <code>message</code> event. Looks for <code>payload.data.text</code>.</p></div>
    ...
    <h4 class="name" id="module:chat-engine-markdown">

    <span class="type-signature"></span>require('chat-engine-markdown')<span class="signature">(config<span class="signature-attributes">opt</span>, event<span class="signature-attributes">opt</span>, prop<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-markdown_src_plugin.js.html">chat-engine-markdown/src/plugin.js</a>, <a href="chat-engine-markdown_src_plugin.js.html#line26">line 26</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>pluginchat = new ChatEngine.Chat('markdown-chat');
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The ChatEngine event where markdown will be parsed</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The event property value where markdown should be parsed.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-markdown_src_plugin.js.html">chat-engine-markdown/src/plugin.js</a>, <a href="chat-engine-markdown_src_plugin.js.html#line1">line 1</a>
    </li></ul></dd>
