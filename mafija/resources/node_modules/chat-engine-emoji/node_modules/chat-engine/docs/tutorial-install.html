...
<head>
    ...
    <title>Install ChatEngine - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">Install ChatEngine</h1>
...
<header>
    ...
    <!-- <h2>Install ChatEngine</h2> -->
</header>

<article>
    <h2>Install PubNub ChatEngine</h2><h3>CDN Hotlink</h3><p>You can grab the latest version of ChatEngine by hotlinking to the GitHub pages
hosted version of ChatEngine</p>
<pre class="prettyprint source lang-js"><code>&lt;script src=&quot;//pubnub.github.io/chat-engine/dist/0.4.2/chat-engine.js&quot;>&lt;/script></code></pre><p>The ChatEngine library will then be available as <code>window.ChatEngineCore</code>.</p>
<h3>NPM</h3><p>Install PubNub ChatEngine by running:</p>
<pre class="prettyprint source lang-sh"><code>npm install chat-engine --save</code></pre><p>This will install the PubNub Chat Engine Javascript SDK into your <code>node_modules</code> directory.</p>
<p>You can then include it directly on the front end by:</p>
<pre class="prettyprint source lang-js"><code>&lt;script src=&quot;node_modules/chat-engine/dist/latest/chat-engine.js&quot;>&lt;/script></code></pre><p>The ChatEngine library will then be available as <code>window.ChatEngineCore</code>.</p>
<p>Or in NodeJS:</p>
<pre class="prettyprint source lang-js"><code>let ChatEngineCore = require('chat-engine');</code></pre>
</article>
