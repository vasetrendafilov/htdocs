...
<head>
    ...
    <title>jQuery Kitchen Sink - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">jQuery Kitchen Sink</h1>
...
<header>
    ...
    <!-- <h2>jQuery Kitchen Sink</h2> -->
</header>

<article>
    <iframe src="https://chat-engine-examples.surge.sh/jquery/kitchen-sink/index.html" width="100%" height="400px"></iframe>
