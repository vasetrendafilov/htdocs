...
<head>
    ...
    <title>chat-engine-desktop-notifications - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">chat-engine-desktop-notifications</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Fires a Notification via the <a href="https://developer.mozilla.org/en-US/docs/Web/API/notification">Web Notifications API</a>
whenever a message is received in the supplied <a href="Chat.html">Chat</a>.</p></div>
    ...
    <h4 class="name" id="module:chat-engine-desktop-notifications">

    <span class="type-signature"></span>require('chat-engine-desktop-notifications')<span class="signature">(config)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-desktop-notifications_src_plugin.js.html">chat-engine-desktop-notifications/src/plugin.js</a>, <a href="chat-engine-desktop-notifications_src_plugin.js.html#line34">line 34</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>room.chat.plugin(ChatEngineCore.plugin['chat-engine-desktop-notifications']({
    title: (event) => {
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The config object</p>
                <h6>Properties</h6>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The event that will trigger a desktop notification</p></td>
        </tr>
...
<span class="param-type"><a href="module-chat-engine-desktop-notifications.html#~title">module:chat-engine-desktop-notifications~title</a></span>
            ...
            <td class="description last"><p>A function that returns title of the notification.</p></td>
        </tr>
...
<span class="param-type"><a href="module-chat-engine-desktop-notifications.html#~message">module:chat-engine-desktop-notifications~message</a></span>
            ...
            <td class="description last"><p>A function that returns the notification message.</p></td>
        </tr>
...
<span class="param-type"><a href="module-chat-engine-desktop-notifications.html#~icon">module:chat-engine-desktop-notifications~icon</a></span>
            ...
            <td class="description last"><p>A function that returns link to an image to use for the notification icon.</p></td>
        </tr>
...
<span class="param-type"><a href="module-chat-engine-desktop-notifications.html#~callback">module:chat-engine-desktop-notifications~callback</a></span>
            ...
            <td class="description last"><p>A function to call when the notification is clicked.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-desktop-notifications_src_plugin.js.html">chat-engine-desktop-notifications/src/plugin.js</a>, <a href="chat-engine-desktop-notifications_src_plugin.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <span class="type-signature"></span>callback<span class="signature">(event)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-desktop-notifications_src_plugin.js.html">chat-engine-desktop-notifications/src/plugin.js</a>, <a href="chat-engine-desktop-notifications_src_plugin.js.html#line68">line 68</a>
    </li></ul></dd>
...
<div class="description">
    <p>Fired when the desktop notification is clicked on by the user.</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="~icon">

    <span class="type-signature"></span>icon<span class="signature">(event)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-desktop-notifications_src_plugin.js.html">chat-engine-desktop-notifications/src/plugin.js</a>, <a href="chat-engine-desktop-notifications_src_plugin.js.html#line147">line 147</a>
    </li></ul></dd>
...
<div class="description">
    <p>Provides a template function to generate a notification icon.</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <span class="type-signature"></span>message<span class="signature">(event)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-desktop-notifications_src_plugin.js.html">chat-engine-desktop-notifications/src/plugin.js</a>, <a href="chat-engine-desktop-notifications_src_plugin.js.html#line153">line 153</a>
    </li></ul></dd>
...
<div class="description">
    <p>Provides a template function to generate a notification message.</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <span class="type-signature"></span>title<span class="signature">(title)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-desktop-notifications_src_plugin.js.html">chat-engine-desktop-notifications/src/plugin.js</a>, <a href="chat-engine-desktop-notifications_src_plugin.js.html#line141">line 141</a>
    </li></ul></dd>
...
<div class="description">
    <p>Provides a template function to generate a notification title.</p>
</div>
