...
<head>
    ...
    <title>jQuery Chat - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">jQuery Chat</h1>
...
<article>
    <iframe src="https://chat-engine-examples.surge.sh/jquery/simple/index.html" width="100%" height="400px"></iframe>
