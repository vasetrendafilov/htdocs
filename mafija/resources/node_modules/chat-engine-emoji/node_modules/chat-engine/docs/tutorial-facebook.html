...
<head>
    ...
    <title>JS Facebook Auth - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">JS Facebook Auth</h1>
...
<header>
    ...
    <!-- <h2>JS Facebook Auth</h2> -->
</header>

<article>
    <h1>Chat Example</h1><iframe src="https://chat-engine-examples.surge.sh/javascript/facebook-login.html" width="100%" height="400px"></iframe>
