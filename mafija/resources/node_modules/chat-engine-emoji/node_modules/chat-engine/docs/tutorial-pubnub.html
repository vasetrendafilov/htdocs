...
<head>
    ...
    <title>Configure ChatEngine - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">Configure ChatEngine</h1>
...
<header>
    ...
    <!-- <h2>Configure ChatEngine</h2> -->
</header>

<article>
    <h1>Automagic PubNub Setup</h1><p>Login below with your PubNub credentials. This will automatically create a new ChatEngine App in your PubNub account, an new key pair, and enable all the PubNub features required for ChatEngine to work properly.</p>
<iframe src="../setup/" width="100%" height="400" /></iframe>

<h1>Manual PubNub Setup</h1><p>Navigate to http://admin.pubnub.com and login or create an account. Don't worry, it's free!</p>
<p>https://admin.pubnub.com</p>
<p>Click &quot;New App.&quot;</p>
<p><img src="/guide/getting-started/assets/README-ddad3667.png" alt=""></p>
<p>Give your new app a name and click &quot;Create.&quot;</p>
<p><img src="/guide/getting-started/assets/README-a6e543f2.png" alt=""></p>
<p>Click on your keyset.</p>
<p><img src="/guide/getting-started/assets/README-84f858cd.png" alt=""></p>
<p>Copy and paste those keys into your <code>app.js</code>.</p>
<pre class="prettyprint source lang-js"><code>const ChatEngine = ChatEngineCore.create({
    publishKey: 'YOUR_PUB_KEY',
    subscribeKey: 'YOUR_SUB_KEY'
});</code></pre><p><img src="/guide/getting-started/assets/README-943bee9f.png" alt=""></p>
<p>Scroll down and enable PubNub Presence.</p>
<p><img src="/guide/getting-started/assets/README-29b7db60.png" alt=""></p>
<blockquote>
<p>Not yet supported.
Enable PubNub Access Manager.
<img src="/guide/getting-started/assets/README-ad7eda0b.png" alt=""></p>
</blockquote>
<p>Scroll down and enable PubNub Storage and Playback. &quot;Retention&quot; is how long messages will be stored in chatrooms.</p>
<p><img src="/guide/getting-started/assets/README-755671fd.png" alt=""></p>
<p>Click &quot;Save Changes.&quot;</p>
<p><img src="/guide/getting-started/assets/README-8e5db3c0.png" alt=""></p>
</article>
