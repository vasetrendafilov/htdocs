...
<head>
    ...
    <title>RootEmitter - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">RootEmitter</h1>
...
<header>
        ...
        RootEmitter
            ...
            <div class="class-description"><p>The <a href="ChatEngine.html">ChatEngine</a> object is a RootEmitter. Configures an event emitter that other ChatEngine objects inherit. Adds shortcut methods for
<code>this.on()</code>, <code>this.emit()</code>, etc.</p></div>
...
<article>
    ...
    <h4 class="name" id="RootEmitter">

    <span class="type-signature"></span>new RootEmitter<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_index.js.html">chat-engine/src/index.js</a>, <a href="chat-engine_src_index.js.html#line70">line 70</a>
    </li></ul></dd>
