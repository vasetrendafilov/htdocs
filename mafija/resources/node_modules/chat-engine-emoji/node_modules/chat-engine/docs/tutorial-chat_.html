...
<head>
    ...
    <title>JS Chat - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">JS Chat</h1>
...
<article>
    <h1>Chat Example</h1><iframe src="https://chat-engine-examples.surge.sh/javascript/chat.html" width="100%" height="400px"></iframe>
