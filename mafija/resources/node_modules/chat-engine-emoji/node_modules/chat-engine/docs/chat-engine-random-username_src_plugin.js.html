...
<head>
    ...
    <title>chat-engine-random-username/src/plugin.js - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">chat-engine-random-username/src/plugin.js</h1>
...
/**
* @function
* @param {Chat} chat The {@link Chat} to add the username to. Most likely will be ```global``` chat.
*/
module.exports = (chat) => {
