...
<head>
    ...
    <title>Angular Desktop Chat - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">Angular Desktop Chat</h1>
...
<header>
    ...
    <!-- <h2>Angular Desktop Chat</h2> -->
</header>

<article>
    <iframe src="https://chat-engine-examples.surge.sh/angular/flowtron/index.html" width="100%" height="400px"></iframe>
