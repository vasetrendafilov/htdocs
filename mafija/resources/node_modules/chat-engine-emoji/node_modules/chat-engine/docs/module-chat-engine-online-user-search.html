...
<head>
    ...
    <title>chat-engine-online-user-search - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <h1 class="page-title">chat-engine-online-user-search</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Searches a <a href="Chat.html">Chat</a> for a <a href="User.html">User</a> with a <code>state().username</code> containing a given string.</p></div>
    ...
    <h4 class="name" id="module:chat-engine-online-user-search">

    <span class="type-signature"></span>require('chat-engine-online-user-search')<span class="signature">(config<span class="signature-attributes">opt</span>, prop<span class="signature-attributes">opt</span>, caseSensitive<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-online-user-search_src_plugin.js.html">chat-engine-online-user-search/src/plugin.js</a>, <a href="chat-engine-online-user-search_src_plugin.js.html#line18">line 18</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>chat = new ChatEngine.Chat('markdown-chat');
chat.plugin(onlineUserSearch({}));
let foundUsers = chat.search('red');</code></pre>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The <a href="User.html#state">User#state</a> property to use for string matching</p></td>
        </tr>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>Enable to consider <code>config.prop</code> character case when searching.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-online-user-search_src_plugin.js.html">chat-engine-online-user-search/src/plugin.js</a>, <a href="chat-engine-online-user-search_src_plugin.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <span class="type-signature">(inner) </span>search<span class="signature">(needle)</span><span class="type-signature"> &rarr; {Array}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-online-user-search_src_plugin.js.html">chat-engine-online-user-search/src/plugin.js</a>, <a href="chat-engine-online-user-search_src_plugin.js.html#line26">line 26</a>
    </li></ul></dd>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The username to search for.</p></td>
        </tr>
...
<div class="param-desc">
    <p>An array of <a href="User.html">User</a>s that match the input string.</p>
</div>
