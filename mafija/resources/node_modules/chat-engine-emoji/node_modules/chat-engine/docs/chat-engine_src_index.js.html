...
<head>
    ...
    <title>chat-engine/src/index.js - PubNub ChatEngine</title>
...
<div id="main">
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// Allows us to create and bind to events. Everything in ChatEngine is an event
// emitter
