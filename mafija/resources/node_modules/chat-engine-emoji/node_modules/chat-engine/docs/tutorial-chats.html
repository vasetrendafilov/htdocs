...
<head>
    ...
    <title>Chats - PubNub ChatEngine</title>
...
<article>
    <p><a href="Chat.html">Chat</a>s are the core object in ChatEngine. Chats are rooms of connected
ChatEngine clients.</p>
<p>A new chat can be made by running:</p>
<pre class="prettyprint source lang-js"><code>let chat = new ChatEngine.Chat('tutorial-chat');</code></pre><p>The chat will automatically connect when created. Then, the client will be
in a <a href="Chat.html">Chat</a> with every other client that has a copy of that chat on their
machine.</p>
<h2>Chat Events</h2><p>When two clients both join a <a href="Chat.html">Chat</a> with the same string
input (<code>tutorial-chat</code> in this case), they can communicate with one
another.</p>
<p>This communication happens through <a href="tutorial-events.html">Events</a>. To send an event to everyone
in a <a href="Chat.html">Chat</a>, call the <a href="Chat.html#emit">Chat#emit</a> method.</p>
<pre class="prettyprint source lang-js"><code>chat.emit('message', {text: 'Hello world!'});</code></pre><p>This will send the &quot;message&quot; event to every other client in the <a href="Chat.html">Chat</a>.</p>
<p>To get notified when a &quot;message&quot; is sent to the <a href="Chat.html">Chat</a>, a client can call
the <a href="Chat.html#on">Chat#on</a> method.</p>
<pre class="prettyprint source lang-js"><code>chat.on('message', (payload) => {
    console.log(payload);
});</code></pre><p>See <a href="tutorial-events.html">Events</a> for more information on events.</p>
<h2>What else can Chats do?</h2><p><a href="Chat.html">Chat</a>s have plenty of cool features. Check out the other tutorials:</p>
<ul>
<li><a href="tutorial-users.html">Users and State</a></li>
<li><a href="tutorial-online-list.html">Online List</a></li>
<li><a href="tutorial-history.html">History</a></li>
<li><a href="tutorial-privacy.html">Privacy</a></li>
<li><a href="tutorial-using.html">Plugins</a></li>
</ul>
<p>For example, <code>chat.users</code> contains a list of all the other <code>User</code>s online in the chat. That list of users will update automatically.</p>
</article>
